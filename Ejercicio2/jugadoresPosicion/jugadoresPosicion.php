...
<ul class="nav">
  ...
  <li class="nav-item">
    <a class="nav-link" href="../bateadores/bateadores.php">bateadores</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="jugadoresPosicion.php">Jugadores de posición</a>
  </li>
          ...
          <table class="table table-bordered table-sm table-striped">
            <thead>
              ...
              <td>numero de uniforme</td>
                ...
                <td>bates</td>
                <td>defensas</td>
                <td>Acciones-bates</td>
                <td>Acciones-defensas</td>
              </tr>
            </thead>
            <tbody id="posicion"></tbody>
          </table>
        </div>
      </div>
    </div>
    ...
    <script src="../../js/jugadoresPosicion.js"></script>
